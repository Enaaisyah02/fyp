<%-- 
    Document   : NavLect
    Created on : 23 Dec 2023, 11:55:33 pm
    Author     : ainan
--%>
    ...
    <body>
        ...
        <div id="sidenav" class="sidenav">
            <ul>
                 ...
                 <li><a href="lectDetails.jsp">Profile</a></li>
                 <li><a href="SVstuList.jsp.jsp">My Student's</a></li>
                <li><a href="fypSchedule.jsp">FYP Material</a></li>
        ...
        <%-- <nav>
            ...
            <ul>
                <li><a href="LecturerDashboard.jsp">Dashboard</a></li>
                <li><a href="fypSchedule.jsp">FYP Schedule</a></li>
                <li><a href="presentationSchedule.jsp">Presentation Schedule</a></li>
                <li><a href="Logout.jsp">Log Out</a></li>
                <!-- Add more navigation links as needed -->
            </ul>
