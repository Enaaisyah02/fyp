        ...
        <div class="profile-container">
            ...
            <li class="profile-card">
                        <%
                            ...
                            String Id = (String) session.getAttribute("lectId");
                            ...
                            if (Id == null || Id.isEmpty()) {
                                ...
                                try {
                                    ...
                                    String myQuery = "SELECT * FROM lecturer WHERE lectId = '" + Id + "'";
                        ...
                        %>
                            ...
                            <p><strong>Lecturer ID:</strong> <%= myResultSet.getString(1)%></p>
                            ...
                            <p><strong>Email:</strong> <%= myResultSet.getString(6)%></p>
                            
                            <div class="action-buttons">
                                <a href="updateProfileLect.jsp?lectId=<%= myResultSet.getString(1)%>">Edit</a>
                            </div>
                       
                        <%
                                    } else {
                                        // Display an error message if the student's details are not found
                                        out.println("Lecturer's detail not found.");
                                    }
                                } catch (Exception e) {
                                    e.printStackTrace();
                                } finally {
