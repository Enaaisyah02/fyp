<%-- 
    Document   : SV
    Created on : 19 Jan 2024, 2:43:05 pm
    Author     : ainan
--%>
...
<html>
    ...
    %>
        ...
        <div class="profile-container">
            ...
            %>
                    <p>Welcome, <%= stuName %> (Student ID: <%= stuId %>)</p>
            <%
                } else {
        ...
        <div class="content">
            <div class="cards">
                <a href="chooseSV.jsp" class="card">
                    <div class="box">
                        <h2>Choose Supervisor</h2>
                    </div>
                    <div class="icon-design">
                        <img src="https://img.favpng.com/21/10/14/computer-icons-management-manager-businessperson-png-favpng-Wvs2UeZBm124xL918bSDp03XS_t.jpg" alt="">
                    </div>
                </a>

                <a href="viewSVregister.jsp" class="card">
                    <div class="box">
                        <h2>View SV registration</h2>
                    </div>
                    <div class="icon-design">
                        <img src="https://cdn4.iconfinder.com/data/icons/ecommerce-47/30/Register-512.png" alt="">
                    </div>
                </a>
            </div>
