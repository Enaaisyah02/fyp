<%-- 
    Document   : NavCoor
    Created on : 21 Dec 2023, 12:36:26 am
    Author     : ainan
--%>
...
<html>
    <head>
        ...
        <title> Nav Bar Coordinator</title>
    ...
    <body>
        <nav class="topnav">
            ...
            <ul>
                <li><a href="CoordinatorDashboard.jsp">Dashboard</a></li>
        ...
        <div id="sidenav" class="sidenav">
            <ul>
                ...
                <li><a href="CoorDetails.jsp">Profile</a></li>
                <li><a href="presentationSchedule.jsp">Presentation Schedule</a></li>
                <li><a href="studLectPage.jsp">Student/SV</a></li>
                <li><a href="listProposal.jsp">Student' Proposal</a></li>
                <li><a href="listStudentTitle.jsp">Student's Project Title</a></li>
                <li><a href="coorTitleApproval.jsp"> Project Title Approval</a></li>
                <li><a href="<%=request.getContextPath()%>/materiallist">List of FYP Material</a>
                <li><a href="<%=request.getContextPath()%>/proposallist">List of Student Proposal</a>
