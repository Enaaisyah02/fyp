<%-- 
    ...
    Created on : 20 Jan 2024, 7:34:11 pm
    Author     : ainan
--%>
         ...
         <ul class="profile-list">
            <li class="profile-card">
                <%
                    ...
                    if (Id == null || Id.isEmpty()) {
                        ...
                        try {
                            ...
                            String myQuery = "SELECT * FROM adminn WHERE adminId = '" + Id + "'";
                ...
                <div class="action-buttons">
                    <a href="updateProfileAdmin.jsp?adminId=<%= myResultSet.getString(1)%>" class="btn btn-primary">Edit Profile</a>
                </div>
                <%
                        } else {
                            out.println("Admin's details not found.");
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                    } finally {
